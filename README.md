...
| **btop-luv / btop-joi** | Real-time node monitors in dev and production. One native exporter per node feeds its Control relay, Core NATS, and the BFF. No SSH collectors or duplicated dev/prod capture. | [Transport contract](./docs/btop.md), [production release](./docs/btop-production.md) |
